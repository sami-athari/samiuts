    ...
    <section className="contentSection py-20 bg-slate-50">
      <div className="container mx-auto px-4 lg:px-0">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="lg:w-1/2 lg:pl-16 text-center lg:text-left mt-8 lg:mt-0"
          >
        ...
        {/* Second Content Block with reverse layout */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
          className="flex flex-col-reverse lg:flex-row-reverse items-center justify-center lg:justify-between mb-20"
        >
          <motion.div
            variants={fadeInUp}
        ...
        {/* Fourth Content Block with reverse layout */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
